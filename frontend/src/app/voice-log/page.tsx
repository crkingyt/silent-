  ...
  const handleAnalysisComplete = (data: any) => {
    ...
    setTimeout(() => {
      ...
      setAnalysisResult({
        ...
        keywords: data.detected_symptoms || [],
        healthMetrics: {
          sleep: data.health_metrics?.sleep || "Unknown",
          stress: data.health_metrics?.stress || "Unknown",
          symptoms: data.detected_symptoms || [],
        },
        prediction: data.prediction || { risk: "General Check", level: "Low" },
